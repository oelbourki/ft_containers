...
void vector_tests(void)
{
    ...
    std::cout << "\033[1;37m[-------------------- [" << std::setw(40) << std::left << " insert method (fill) " << "] --------------------]\t\t\033[0m";
    {
        ...
        /*
            ...
            */
        bool cond;
    std::cout << "\n\033[1;37m[-------------------- [" << std::setw(40) << std::left << " test 1: empty vector " << "] --------------------]\t\t\033[0m";
        /*------------------------------- test 1: empty vector ----------------------------------------*/
        // insert at the begin
        {
            std::vector<std::string>    v;
    ...
    std::cout << "\033[1;37m[-------------------- [" << std::setw(40) << std::left << " test 2: the vector capacity >= size + n" << "] --------------------]\t\t\033[0m";
        ...
        { 
            ...
            std::cout << "\nstd:" << str.length() << std::endl;
            std::cout << "ft :" << ft_str.length() << std::endl;

            std::cout << (str == ft_str) << std::endl;
            std::cout << (s == ft_s) << std::endl;
            std::cout << (c == ft_c) << std::endl;
            std::cout << (&(*valid_it) == &(*ft_v.begin())) << std::endl;


        }
        EQUAL(cond);

    std::cout << "\033[1;37m[-------------------- [" << std::setw(40) << std::left << "test 3: the vector capacity < size + n && n > size" << "] --------------------]\t\t\033[0m";
        // /*---------------------------------------------------------------------------------------------------*/
        ...
        EQUAL(cond);
    std::cout << "\033[1;37m[-------------------- [" << std::setw(40) << std::left << "test 4: the vector capacity < size + n && n <= size" << "] --------------------]\t\t\033[0m";
