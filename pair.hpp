  ...
  bool equal ( InputIterator1 first1, InputIterator1 last1, InputIterator2 first2 )
{
  ...
  bool lexicographical_compare (InputIterator1 first1, InputIterator1 last1,
    ...
    // template< class Iterator >
    // class const_reverse_iterator_tree;
  template< class Iterator >
    class reverse_iterator_tree
	{
		...
		// operator reverse_iterator_tree<const Iterator>() const{ return reverse_iterator_tree<const Iterator>(z);}
		...
		// reverse_iterator_tree(Iterator init){z = init.base();};
      ...
      z = --init;};//must work
		...
		// bool 			operator>(const reverse_iterator_tree &v){return this->z > v.z;}
		// bool 			operator>=(const reverse_iterator_tree &v){return this->z >= v.z;}
		// bool 			operator<(const reverse_iterator_tree &v){return this->z < v.z;}
		// bool 			operator<=(const reverse_iterator_tree &v){return this->z <= v.z;}
		// bool 			operator != (const reverse_iterator_tree &v){return this->z != v.z;}
		// bool 			operator== (const reverse_iterator_tree &v){ 
    //   return this->z == v.z;}
