...
//add typedef
template<class T>
typename ft_vector<T>::iterator	ft_vector<T>::insert(ft_vector<T>::iterator position, const value_type& val)
{
...
template<class T>
const T&  ft_vector<T>::at(size_type n) const
{
	if (n >= this->_size)
		throw std::out_of_range("out of rang");
	else 
...
template <class T >
typename ft_vector<T>::iterator  ft_vector<T>::erase(ft_vector<T>::iterator first, ft_vector<T>::iterator last)
{
	int copy = this->_size;
...
template <class T >
typename ft_vector<T>::iterator  ft_vector<T>::erase(ft_vector<T>::iterator position)
{
	T *new_arr = new T[this->_capacity]();
...
template <class T>
typename ft_vector<T>::size_type    ft_vector<T>::max_size() const
{
...
template <class T>
const T&    ft_vector<T>::back() const
{
	return (this->_arr[this->size() - 1]);
}
template <class T>
...
template <class T>
const T&    ft_vector<T>::front() const
{
	return (this->_arr[0]);
}
template <class T>
...
template <class T>
void    ft_vector<T>::push_back(const T& v)
{
...
template <class T>
ft_vector<T>::ft_vector() :_size(0),_capacity(0)
{
	this->_arr = new T[0]();
}
template <class T>
...
template <class T>
typename ft_vector<T>::reference ft_vector<T>::operator[](int i)
{
	if (i >= this->_size)
...
template <class T>
typename ft_vector<T>::const_reference ft_vector<T>::operator[](int i) const
{
	if (i >= this->_size)
		throw std::out_of_range("out of range");
	else 
...
template <class T>
typename ft_vector<T>::size_type  ft_vector<T>::size() const
{
	return this->_size;
}
template <class T>
