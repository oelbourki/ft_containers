...
namespace ft
{
	...
	class list
	{
		...
		class const_iterator : public std::iterator<std::bidirectional_iterator_tag, T>
		{
			...
			typedef T* pointer;
			const_iterator(Node* init){z = init;};
			...
			bool 			operator<(const const_iterator &v){return this->z < v.z;}
			bool 			operator<=(const const_iterator &v){return this->z <= v.z;}
			const_iterator 		&operator++(){z = z->next;;return *this;}
			const_iterator 		&operator--(){z = z->prev;return *this;}
			const_iterator 		&operator--(int){const_iterator tmp = *this;(--this);return *this;}
			const_iterator		operator++(int) {const_iterator copy = *this;++(*this);return copy;}
			reference		operator*(){return z->data;};
			value_type*		operator->(){
				return &z->data;};
				const_iterator& operator= (const const_iterator& x){this->z = x.z;return *this;}
		};
		class iterator : public std::iterator<std::bidirectional_iterator_tag, T>
		{
			...
			value_type*		operator->(){
				return &z->data;};
			iterator& operator= (const iterator& x){this->z = x.z;return *this;}
		};
		...
		iterator insert (const value_type& val);//done
		...
		// template <class T,class Compare>
		// 	bool operator== (const list<T,Compare>& lhs, const list<T,Compare>& rhs);
		// template <class T,class Compare>
		// 	bool operator!= (const list<T,Compare>& lhs, const list<T,Compare>& rhs);
		// template <class T,class Compare>
		// 	bool operator<  (const list<T,Compare>& lhs, const list<T,Compare>& rhs);
	...
	template<class T,class Compare>
	typename list<T,Compare>::iterator list<T,Compare>::insert(const value_type& val)
	{
        iterator position = ft::lower_bound(this->begin(),this->end(),val);
		return this->insert(position,val);
	}
	template<class T,class Compare>
	typename list<T,Compare>::iterator list<T,Compare>::insert(iterator position, const value_type& val)
	{
		// std::cout << "insert\n";
        position = ft::lower_bound(this->begin(),this->end(),val,this->cmp);
	...
	template<class T,class Compare>
	void list<T,Compare>::insert (iterator position, size_type n, const value_type& val)
	{
		while (n--)
			insert(position,val);
	}
	template<class T,class Compare>
	template <class InputIterator>
		void list<T,Compare>::insert (iterator position, InputIterator first, InputIterator last)
		{
			while (first != last)
				insert(position,*(first++));			
		}
	template<class T,class Compare>
	typename list<T,Compare>::iterator list<T,Compare>::erase (iterator position)
	{
	...
	template<class T,class Compare>
	typename list<T,Compare>::iterator list<T,Compare>::erase (iterator first, iterator last)
	{
		while (first != last)
			erase(first++);
	...
	template<class T,class Compare>
	list<T,Compare>& list<T,Compare>::operator= (const list<T,Compare>& x)
	{
		if (this != &x)
		{
			iterator f1 = begin();
	...
	template <class T,class Compare>
		void swap (list<T,Compare>& x, list<T,Compare>& y)
		{
			T tmp;
			tmp = x;
			x = y;
	...
	template <class T,class Compare>
		void list<T,Compare>::swap (list<T,Compare>& x)
		{
			swap(node,x.node);
			swap(length,x.length);
		}
	template <class T,class Compare>
		void list<T,Compare>::splice (iterator position, list& x)
		{
			if (!x.empty())
			{
	...
	template <class T,class Compare>
		void list<T,Compare>::splice (iterator position, list& x, iterator i)
		{
			iterator j = i;
	...
	template <class T,class Compare>	
		void list<T,Compare>::splice (iterator position, list& x, iterator first, iterator last)
		{
			if (first != last)
			{
				if (this != &x)
	...
	template<class T,class Compare>
		void list<T,Compare>::remove (const value_type& val)
		{
	...
	template<class T,class Compare>
		template <class BinaryPredicate>
			void list<T,Compare>::unique (BinaryPredicate binary_pred)
			{
				iterator first = begin();
				iterator last = end();
				if (first == last)
	...
	template<class T,class Compare>
		void list<T,Compare>::merge (list& x)
		{
			iterator f1 = begin();
			iterator l1 = end();
			iterator f2 = x.begin();
	...
	template<class T,class Compare>
			void list<T,Compare>::merge (list& x, Compare comp)
			{
				iterator f1 = begin();
				iterator l1 = end();
				iterator f2 = x.begin();
	...
	template<class T,class Compare>
	template <class InputIterator>
		void list<T,Compare>::assign (InputIterator first, InputIterator last)
		{
			if(first != last)
			{
				this->clear();
	...
	template<class T,class Compare>
		void list<T,Compare>::assign (size_type n, const value_type& val)
		{
			while (n--)
				push_front(val);
		}
	template<class T,class Compare>
		template <class Predicate>
			void list<T,Compare>::remove_if (Predicate pred)
			{
			iterator begin = begin();
			iterator end = end();
			while (begin != end)
	...
	template<class T,class Compare>
	void list<T,Compare>::resize (size_type n, value_type val)
	{
		iterator f= begin();
		iterator l = end();
		while (f != l && n--)
...
// 			iterator		operator++(int) {iterator copy = *this;++(*this);return copy;}
// 			reference		operator*(){return z->data;};
// 			// pointer		operator*(){std::cout << "i amin\n";return &z->data;};
// 			value_type*		operator->(){
// 				return &z->data;};
// 		};
// 		typedef std::reverse_iterator<iterator>
...
// 		iterator insert (iterator position, const value_type& val,Compare);//single element (1)//done
// 		iterator insert (iterator position, const value_type& val);//single element (1)//done
// 		void insert (iterator position, size_type n, const value_type& val);//fill (2)//done
// 		template <class InputIterator>
// 			void insert (iterator position, InputIterator first, InputIterator last);//range (3)//done
...
// 	template<class T>
// 	template<class Compare>
// 	typename list<T>::iterator list<T>::insert(const value_type& val,Compare cmp)
// 	{
//         iterator position = ft::lower_bound(this->begin(),this->end(),val,cmp);
// 		Node* tmp = creat_node();
// 		tmp->data = val;
// 		new (&(tmp->data)) T(val);
// 		tmp->next = position.z;
